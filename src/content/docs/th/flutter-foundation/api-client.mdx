...
### 2. base URL — ขยาย `lib/src/core/env.dart`
...
### 3. domain error — `lib/src/core/api/api_exception.dart`
...
### 4. ตัว client — `lib/src/core/api/fittrack_api.dart`
...
### 5. ตัว provider — `lib/src/core/api/api_providers.dart`
