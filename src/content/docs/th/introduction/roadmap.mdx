...
description: "FitTrack คือโปรเจกต์ #4 ของ series ที่มีหกโปรเจกต์ ซึ่งดัดแปลง Learn Hub catalog ทั้งหมดให้เป็นแอปจริง นี่คือที่ที่มันอยู่และอะไรอยู่รอบ ๆ มัน"
sidebar:
  order: 4
---
...
platform สำหรับ content: author เขียนใน headless CMS แล้ว blog สาธารณะที่เร็วก็ render มันผ่าน **GraphQL** API ด้วย SSR และ ISR
...
คุณเข้าใจภาพรวมแล้วเมื่อพูดได้อย่างละประโยคว่า FitTrack สร้างอะไร, ดัดแปลง catalog ส่วนไหน และมันต่างจากสามโปรเจกต์ก่อนหน้ายังไง ต่อไป เริ่ม [Module 1 · Setup & Tooling](/fittrack/th/setup/)
