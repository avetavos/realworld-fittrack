...
- **Python 3.12+** and **[uv](https://docs.astral.sh/uv/)** — the fast Python package and project manager the backend uses. `uv` handles the virtualenv, dependencies, and running the app.
